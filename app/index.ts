...
const conexion = (serviceAccount: string, databaseURL: string) => {
...
export { conexion, admin, getDb, meGustaIncrementar, noMeGustaDecrementar, actualizarDocumento,
    actualizarSubDocumento, agregarDocumento, agregarSubDocumento, CrearSubDocumento,
