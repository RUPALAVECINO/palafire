...
var coleccion = function (colections) { return colections; };
var subcoleccion = function (subcolections) { return subcolections; };
...
var obtenerDatosSubColeccion = function (num, documento, num2) { return __awaiter(void 0, void 0, void 0, function () {
    var datos_coleccion_1, collection, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
            ...
            case 1:
                ...
                collection.forEach(function (doc) {
                    var data = doc.data();
                    datos_coleccion_1.push(data);
                });
                return [2 /*return*/, datos_coleccion_1];
            case 2:
                err_2 = _a.sent();
                console.error(err_2);
                return [3 /*break*/, 3];
...
var actualizarSubDocumento = function (num, documento, num2, subdocumento, actualizar) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, firestore.collection("" + coleccion[num])
                        .doc("" + documento)
                        .collection("" + subcoleccion[num2])
                        .doc("" + subdocumento)
                        .update(actualizar)];
...
var eliminarDocumento = function (num, uid) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, firestore.doc(coleccion[num] + "/" + uid)["delete"]()];
            case 1:
                _a.sent();
                return [3 /*break*/, 3];
            case 2:
